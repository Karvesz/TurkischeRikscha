...
import com.example.turkischerikscha.BinaryTree;
import com.example.turkischerikscha.CONgame;
import com.example.turkischerikscha.Spieler;
import com.example.turkischerikscha.Spielfeld;
...
public class Spiel {
    ...
    public void altStart(BinaryTree<Spieler> baum) {
        ...
        lb1.setText("Der zufällig ausgewählte Spieler ist: " + zufaelligerSpieler.getName());
